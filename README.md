...
로마자 표기 후보를 여럿 만들어 ClinicalTrials.gov 에 각각 묻고 합친다. 다만 **추측한 표기라고
밝히고** 어느 표기가 몇 건이었는지 보인다. 소속 기관이나 연구 주제를 함께 적으면 CRIS 에서
실제 등록된 표기를 읽어 정확히 대조한다. 모델은 조건 변환만 하고 결과를 요약하거나
