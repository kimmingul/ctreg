...
한국어로·ctgov 를 표기 둘로 동시에 → 105건, 84초. "당뇨 관련 우수한 연구자 5명" → `ctreg investigators`
(검색어에 걸린 CRIS 시험 전체를 연구책임자로 묶어 건수순) 한 번으로 276건 전수 순위 — "우수함은
레지스트리가 판정 못 한다, 등록 건수다" 를 밝힌다.
